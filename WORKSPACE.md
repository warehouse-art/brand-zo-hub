...
**ولا يلزمك تشغيله في الاتّجاه الآخر:** المستودع الشخصيّ يسحب من هنا **تلقائيًّا كلّ ساعة** بالورك-فلو نفسه — الملفّ واحدٌ في المستودعَين، ولا يعمل إلّا حيث تأذن بطاقتُه (`autoSync`)، فيستحيل أن يتقاذفا المزامنة. فما تدفعه إلى `main` هنا يبلغه خلال ساعة، بعد بوّابةٍ خضراء.
