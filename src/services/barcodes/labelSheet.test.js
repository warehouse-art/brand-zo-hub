...
test('ملصق الرفّ: المؤهَّل كبيرًا والقانونيُّ تحته — وكلاهما مشتقٌّ من الكود', () => {
  const label = buildSheetLabel('W01-A01-R01-B09-LF-P01', { qualifier: RH });
  assert.equal(label.headline, 'BR-RH-W01-A01-R01-B09-LF-P01');
  // تصحيح 2026-09-02: كان السطرُ الثاني اختصارًا يُسقط الممرّ، فيتقاسمه رفوفٌ
  // كثيرة — وملصقٌ لا يميّز رفَّه ليس ملصقًا. الآن هو الكودُ القانونيّ كاملًا.
  assert.equal(label.subline, 'W01-A01-R01-B09-LF-P01', 'مشتقٌّ من الكود لا مكتوبٌ بجانبه');
});
