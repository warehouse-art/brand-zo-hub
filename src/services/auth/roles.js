...
export const ROLES = {
  ...
  /**
   * موظّف جردٍ مكلَّف ‹RB-201› — **تكليفٌ من الإدارة العامّة، لا وظيفة**.
   *
   * ★ وهو **عكسُ مدقّق الجرد** لا نسخةٌ منه: المدقّقُ دورٌ رقابيٌّ دائمٌ يتبع
   * مدير السلاسل ويرى تقارير المخزون كلَّها؛ وهذا **مكلَّفٌ لمهمّةٍ بعينها**
   * يأتي فيعدّ ويمضي. فلا يُعطى إلّا شاشةَ العدّ — والباقي ليس من شأنه.
   *
   * وأضيقُ دورٍ في البوّابة عمدًا: **مدخلٌ واحد** (`stock-operations`).
   * توسيعُه قرارُ مالكٍ لا اجتهادُ كود.
   */
  count_assignee:    { id: 'count_assignee',    label: 'موظّف جرد مكلَّف',  emoji: '🔢', color: '#7c2d12' },
  /**
   * مديرُ إدارة السلاسل والإمداد والمخازن ‹RB-202› — أعلى أدوار الدليل.
   *
   * ★ والمصفوفةُ 6.3 تجعله **مراجعًا** لـPR وPO وSO، و**معتمِدًا** لـDN
   * وTR وTRN وTRC وCC. وهو غيرُ مدير المستودع: ذاك رئيسُ قسمٍ تحته.
   *
   * وللدليل نصٌّ فيه: «إشرافٌ شاملٌ واطّلاعٌ كامل **دون تجاوز ضوابط
   * الفصل بين المهامّ**» — فالاطّلاعُ واسعٌ والفعلُ محكوم.
   */
  scm_manager:       { id: 'scm_manager', label: 'مدير السلاسل والإمداد', emoji: '🏛️', color: '#4A2B3A' },
  /**
   * وحدةُ الاستلام والرقابة ‹RB-202› — **مُنشئةُ GRN وSRN** في مصفوفة 6.3.
   * تُفرّغ الشحنة وتطابق الكمّيّات وترفض ما لا يُطابق، ولا تعتمد شيئًا:
   * اعتمادُ GRN لمفتّش الجودة، وSRN لمدير الجودة.
   */
  receiving_unit:    { id: 'receiving_unit', label: 'وحدة الاستلام والرقابة', emoji: '📥', color: '#0369a1' },
  /**
   * وحدةُ التخزين وتحديد المواقع ‹RB-202› — **مُنشئةُ PUTAWAY** في المصفوفة.
   * تحدّد الموقع وتطبّق FEFO وتسجّل التشغيلة والصلاحية؛ ومراجعتُها لمدقّق
   * الجرد، واعتمادُها لمدير المستودع.
   */
  putaway_unit:      { id: 'putaway_unit', label: 'وحدة التخزين وتحديد المواقع', emoji: '🗄️', color: '#7c3aed' },
  /**
   * وحدةُ تحضير الطلبات والصرف ‹RB-202› — **مُنشئةُ PICK** في المصفوفة.
   * تنتقي وتعبّئ وتشحن؛ ومراجعةُ PICK لأمين المخزن واعتمادُها لمدير المستودع.
   */
  picking_unit:      { id: 'picking_unit', label: 'وحدة تحضير الطلبات والصرف', emoji: '📤', color: '#c2410c' },
};
