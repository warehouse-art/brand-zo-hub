...
/**
 * التسمية التي يراها العامل — **الكود كاملًا كما هو مطبوعٌ على الملصق**.
 *
 * ★★ تصحيح 2026-09-02 (بيّنة ملصقات طرابلس والرحبة): كانت هذه الدالّة تختصر
 * فتُسقط الممرّ — `TR-A-R-01-01` و`TR-B-R-01-01` تعودان كلتاهما `R-01-01`.
 * وبالقياس على المخطّطين المعتمدين: **٣٦٠٠ خانةٍ تنهار إلى ١٠٠ تسمية**، والواحدةُ
 * تشير إلى ٢٦ خانةً في الرحبة. وهي التسمية المطبوعة على الملصق وفي خطّة السحب
 * ولوحة العامل وخريطة المستودع — فمن يقرأ `L-01-01` لا يعرف أيَّ ممرٍّ يقصد.
 *
 * والاختصار **يُتقاعَد ولا يُصلَح**: أيُّ اختصارٍ لخمسة مقاطعَ يُسقط مقطعًا، وكلُّ
 * مقطعٍ هنا يميّز. وقرار المالك (2026-09-02): يرى العاملُ الكودَ كاملًا — نفسَ
 * المطبوع على الملصق حرفيًّا، فلا اسمان لشيءٍ واحد.
 *
 * وتبقى الدالّة قائمةً ولا تُحذف: لها عشرةُ مستدعين، و**موضع «ما يراه العامل»
 * يجب أن يبقى موضعًا واحدًا** يُغيَّر منه لو عاد الاختصار يومًا.
 */
