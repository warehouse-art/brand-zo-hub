...
export const STANDALONE_TYPES = Object.freeze({
  ...
  TDR: 'محضر فرق النقل: محضرٌ رقابيٌّ يُحرَّر على استلامٍ وقع (TRC) ويوثّق فرقَ الحمولة والطرف المتحمِّل والحركة التصحيحية. لا كمّيّةَ تُشتقّ منه ولا إليه: القيدُ وقع في TRN وTRC، والنقصُ العالق ظاهرٌ في مخزن النقل — فإدراجه في سلسلةٍ كمّيّةٍ يحرّك البضاعة مرّتين (نفس علّة GP وVSR).',
